...
module.exports = app => {
    ...
    app.post("/monarca/comentario/agregarReporteComentarioLugar", comentarioController.agregarReporteComentarioLugar);  
    ...
    app.post("/monarca/comentario/agregarReporteComentarioTour", comentarioController.agregarReporteComentarioTour);  
    ...
    app.post("/monarca/comentario/agregarReporteComentarioCompania", comentarioController.agregarReporteComentarioCompania);  
